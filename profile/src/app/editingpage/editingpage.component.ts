...
export class EditingpageComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder) {
    ...
    this.form = this.fb.group({
      caption:new FormControl('Welcome to Hawks Hospital',Validators.required),
      ...
      cardtitle2: new FormControl('Lorem ipsum dolor sit amet',Validators.required),
      cardtext2: new FormControl('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at, luctus dui. Mauris magna metus, dapibus nec turpis vel, semper malesuada ante. Idac bibendum scelerisque non non purus. Suspendisse varius nibh non aliquet.', Validators.required),
      ...
      doctortext2:new FormControl('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at, luctus dui. Mauris magna metus, dapibus nec turpis vel, semper mal.', Validators.required),
      doctortext3:new FormControl('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at, luctus dui. Mauris magna metus, dapibus nec turpis vel, semper mal.', Validators.required),
      doctortext4:new FormControl('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at, luctus dui. Mauris magna metus, dapibus nec turpis vel, semper mal.', Validators.required),
      servicecontent:new FormControl('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at, luctus dui. Mauris magna metus, dapibus nec turpis vel, semper mal.', Validators.required),
